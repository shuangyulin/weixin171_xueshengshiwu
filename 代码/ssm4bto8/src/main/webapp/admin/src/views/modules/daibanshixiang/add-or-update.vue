  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.daibanshijian" label="待办时间" prop="daibanshijian">
              <el-input v-model="ruleForm.daibanshijian" 
                placeholder="待办时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.daibanshijian = this.getCurDateTime()
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.nianji!=''&&json.nianji){
          ...
          this.$message.error(data.msg);
            ...
            this.zhuangtaiOptions = "未完成,进行中,已完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssm4bto8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
