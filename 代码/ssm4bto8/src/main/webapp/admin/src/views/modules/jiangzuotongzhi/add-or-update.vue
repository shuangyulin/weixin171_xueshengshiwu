<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属平台" prop="suoshupingtai">
          <el-input v-model="ruleForm.suoshupingtai" 
              placeholder="所属平台" clearable  :readonly="ro.suoshupingtai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属平台" prop="suoshupingtai">
              <el-input v-model="ruleForm.suoshupingtai" 
                placeholder="所属平台" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiangzuotongzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiangzuotongzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
